...
CREATE TABLE Information_Allied (
    Id_Allied INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Inventory_Allied_Characters (
    Id_Allied_Inventory INTEGER AUTO_INCREMENT PRIMARY KEY,
    Name_Character VARCHAR(100),
...
CREATE TABLE lunatic_Occultist (
    Id_Allied INTEGER,
    Id_Boss INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Solar_Pilar (
    Id_Enemies_Solar INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Stardust_Pilar (
    Id_Enemies_Stardust INTEGER AUTO_INCREMENT PRIMARY KEY,
    Name_Minion VARCHAR(100),
    Pv INT(1),
    Atk INT(1),
    Def INT(1)
...
CREATE TABLE Nebulla_Pilar (
    Id_Enemies_Nebulla INTEGER AUTO_INCREMENT PRIMARY KEY,
    Name_Minion VARCHAR(100),
    Pv INT(1),
    Atk INT(1),
    Def INT(1)
...
CREATE TABLE Vortex_Pilar (
    Id_Enemies_Vortex INTEGER AUTO_INCREMENT PRIMARY KEY,
    Name_Minion VARCHAR(100),
    Pv INT(1),
    Atk INT(1),
    Def INT(1)
...
CREATE TABLE MoonLord (
    Id_MoonLord INTEGER AUTO_INCREMENT PRIMARY KEY,
    Pv INT,
    Atk INT,
    Def INT
);
...
FROM
    ...
    /*Quanto a Radius Esfere "oder do Ocultista Lunatico, causa de dano"*/
